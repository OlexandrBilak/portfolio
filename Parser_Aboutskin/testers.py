...
base_url = "https://aboutskin.com.ua/product-category/testers/page/{page}/"
all_products = []
...
while True:
    ...
    products = soup.find_all('div', class_='product-element-top wd-quick-shop')

    if not products:
        break  # більше товарів немає
...
# записуємо у testers.txt
with open("categories/testers.txt", "w", encoding="utf-8") as f:
    for url in all_products:
        f.write(url + "\n")

print(f"[OK] Зібрано {len(all_products)} товарів у testers.txt")
